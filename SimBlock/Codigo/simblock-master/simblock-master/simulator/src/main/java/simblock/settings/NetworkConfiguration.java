...
public class NetworkConfiguration {
  ...
  private static final long[][] LATENCY_2019 = {
    {32, 350, 184, 198, 151, 189},  
    {350, 120, 400, 420, 450, 470}, 
    {184, 400, 88, 325, 301, 322},  
    {198, 420, 325, 85, 58, 198},   
    {151, 450, 301, 58, 12, 126},   
    {189, 470, 322, 198, 126, 16}   
  };
  ...
  private static final long[] DOWNLOAD_BANDWIDTH_2019 = {
    52000000, 1000000, 18000000, 22800000, 22800000, 29900000, 6 * 1000000
  };

  private static final long[] UPLOAD_BANDWIDTH_2019 = {
    19200000, 512000, 5800000, 15700000, 10200000, 11300000, 6 * 1000000
  };
  ...
  /**
   * The cumulative distribution of number of outbound links. Cf. Andrew Miller et al., "Discovering
